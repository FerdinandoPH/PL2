 ...
 * @author tizia
 */
public class GUI_dialogRegistro extends javax.swing.JDialog {
    
    /**
     * Creates new form registro
     */
    public GUI_dialogRegistro(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void aceptarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarButtonActionPerformed
        ...
        if (errores.length()>0){
            ...
            if (tipoComboBox.getSelectedItem().equals("Particular")){
                GUI_dialogDatosParticular dialogoDatosParticular = new GUI_dialogDatosParticular(this, true, new String [] {correoField.getText(), new String(claveField.getPassword()), new String(clave2Field.getPassword()), dniField.getText(), nombreField.getText(), telefonoField.getText()});
                GUI_dialogRegistro dialogoRegistro = this;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_dialogRegistro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GUI_dialogRegistro dialog = new GUI_dialogRegistro(new javax.swing.JFrame(), true);
